...
{
    //check of item     al bestaat met dit id
    ...
    var BucketListitems = new Bucketlistitem
    {
        NameBucketListItem = itemName,
        DescriptionBucketListItem = itemDescription
    };
    db.Bucketlistitems.Add(BucketListitems);
    await db.SaveChangesAsync();

    return Results.Created($"bucketlistitem", BucketListitems);
});
